    ...
    return (
        <Section className="min-h-screen flex items-center justify-center pt-32 pb-20 relative overflow-hidden" id="home">
            ...
            <Container className="relative z-10 text-center flex flex-col items-center">
                ...
                <motion.p
                    className="text-sm md:text-base uppercase tracking-[0.2em] text-foreground/50 mb-5"
                ...
                >
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-accent/80 to-accent">
                        {personal.headline}
                    </span>
                </motion.h1>
                ...
                >
                    {personal.quickFacts.map((fact) => (
                        <div
                            key={fact.label}
                            className="glass rounded-full px-4 py-2 text-sm text-foreground/80 border border-white/10 hover:border-accent/35 hover:text-accent transition-colors"
                        >
                            <span className="text-foreground/50">{fact.label}:</span>{" "}
