  ...
  return (
    <Section id="projects" className="bg-foreground/[0.02]">
      <Container>
        ...
        >
          {t.projects.map((project: ProjectItem) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Card
                    interactive
                    className="group overflow-hidden border border-border/60 p-0"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-5">
                      ...
                      <div className="flex flex-col p-6 md:col-span-3 md:p-8">
                        ...
                        <h3 className="mb-3 text-2xl font-bold transition-colors duration-300 group-hover:text-accent">
                          {project.title}
                        </h3>
